...
class ModelRunner:
    ...
    def predict_year_target(prediction_symbol="FDX", start_date=datetime.date(2017, 8, 30)):
        ...
        model1_prediction = model1.predict_symbol(prediction_symbol, start_date,
        ...
        model2_prediction = model2.predict_symbol(prediction_symbol, start_date,
                                                  day_diff="year", scaler_filename="training_test_scaler.scaler")
        ...
        model3_prediction = model3.predict_symbol(prediction_symbol, start_date,
                                                  day_diff="year", scaler_filename="training_test_scaler.scaler")
        ...
        model4_prediction = model4.predict_symbol(prediction_symbol, start_date,
                                                  day_diff="year", scaler_filename="training_test_scaler.scaler")
