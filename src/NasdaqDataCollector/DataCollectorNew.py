...
def getDataUrl(stock):
    return "https://www.alphavantage.co/query?function=TIME_SERIES_MONTHLY_ADJUSTED&symbol={}&apikey={}".format(stock, "A5ZQ7ESZOUG7B3TU")
...
def getStockData(stock):
    ...
    dividend_yield = stock_state['DividendYield']
    dividend_per_share = stock_state['DividendPerShare']
    one_yr_target_price = stock_state['AnalystTargetPrice']
